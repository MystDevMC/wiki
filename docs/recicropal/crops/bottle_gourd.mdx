...
<JsonStructure title="Filling Recipe">
  ...
  <JsonNode content={<><JsonDataType type="obj"/> <code>fluid</code> A fluid definition to fill the bottle with.</>}>
    ...
    <JsonNode content={<><JsonDataType type="obj"/> <code>nbt</code> The NBT to attach to the fluid filled structured as-is and not as a string.</>}/>
  </JsonNode>
...
<JsonStructure title="Pouring Recipe">
  ...
  <JsonNode content={<><JsonDataType type="obj"/> <code>fluid</code> A fluid definition to fill the item with.</>}>
    ...
    <JsonNode content={<><JsonDataType type="obj"/> <code>nbt</code> The NBT to match structured as-is and not as a string.</>}/>
  </JsonNode>
...
These bottles may contain mixtures with interesting compositions of potion effects.
